...
public class PowerManager {
    ...
    public void addMastery(Player player, PowerType type, double amount) {
        ...
        double scaled = amount * 0.55;
        state.setMastery(before + scaled);
    ...
    private void applyAwakenedPassives(Player player) {
        applyIfAwakened(player, PowerType.METAL_JAW, PotionEffectType.REGENERATION, 1);
        applyIfAwakened(player, PowerType.SKY_SENTINEL, PotionEffectType.SLOW_FALLING, 0);
        applyIfAwakened(player, PowerType.TITAN_GUARD, PotionEffectType.RESISTANCE, 2);
        applyIfAwakened(player, PowerType.BLAZE_RUNNER, PotionEffectType.SPEED, 2);
        applyIfAwakened(player, PowerType.STORM_LANCER, PotionEffectType.SPEED, 1);
        applyIfAwakened(player, PowerType.PHASE_STEPPER, PotionEffectType.SPEED, 1);
        applyIfAwakened(player, PowerType.OCEAN_WARDEN, PotionEffectType.DOLPHINS_GRACE, 2);
        applyIfAwakened(player, PowerType.FROST_KNIGHT, PotionEffectType.RESISTANCE, 1);
        applyIfAwakened(player, PowerType.SHADOW_SPECTER, PotionEffectType.INVISIBILITY, 0);
        applyIfAwakened(player, PowerType.SOLAR_MONK, PotionEffectType.HASTE, 1);
        applyIfAwakened(player, PowerType.LUNAR_ASSASSIN, PotionEffectType.NIGHT_VISION, 0);
        applyIfAwakened(player, PowerType.ARC_PUNCHER, PotionEffectType.STRENGTH, 1);
        applyIfAwakened(player, PowerType.EARTHSHAKER, PotionEffectType.JUMP_BOOST, 1);
        applyIfAwakened(player, PowerType.IRON_HEART, PotionEffectType.REGENERATION, 1);
        applyIfAwakened(player, PowerType.TOXIC_VEIL, PotionEffectType.RESISTANCE, 1);
        applyIfAwakened(player, PowerType.THORN_GUARDIAN, PotionEffectType.RESISTANCE, 1);
        applyIfAwakened(player, PowerType.CRYSTAL_ARCHER, PotionEffectType.HASTE, 1);
        applyIfAwakened(player, PowerType.NETHER_REAVER, PotionEffectType.FIRE_RESISTANCE, 0);
        applyIfAwakened(player, PowerType.AETHER_WING, PotionEffectType.SLOW_FALLING, 0);
        applyIfAwakened(player, PowerType.BULWARK, PotionEffectType.RESISTANCE, 2);
        applyIfAwakened(player, PowerType.WILD_CALLER, PotionEffectType.REGENERATION, 1);
        applyIfAwakened(player, PowerType.LIGHT_BRINGER, PotionEffectType.NIGHT_VISION, 0);
        applyIfAwakened(player, PowerType.VOID_WALKER, PotionEffectType.SPEED, 1);
        applyIfAwakened(player, PowerType.THUNDERCLAP, PotionEffectType.STRENGTH, 1);
        applyIfAwakened(player, PowerType.GEARMIND, PotionEffectType.HASTE, 1);
        applyIfAwakened(player, PowerType.STARFORGED, PotionEffectType.SPEED, 1);
        applyIfAwakened(player, PowerType.PHOENIX_SOUL, PotionEffectType.FIRE_RESISTANCE, 0);
        applyIfAwakened(player, PowerType.GRAVITY_KNIGHT, PotionEffectType.JUMP_BOOST, 1);
        applyIfAwakened(player, PowerType.BEACON_SPIRIT, PotionEffectType.LUCK, 1);
        applyIfAwakened(player, PowerType.RIFT_BLADE, PotionEffectType.SPEED, 1);
    }
